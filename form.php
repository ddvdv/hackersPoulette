		...
		<div class="header">
			...
			<form class="pure-form pure-form-aligned pure-g" method="get" action="receiver.php">
				...
				<div class="pure-control-group">
					...
					<input class="pure-input-1-2" type="text" name="lastname" id="lastname" required>
				</div>

				<div class="pure-control-group">
					<label for="email">Email</label>
					<input class="pure-input-1-2" type="email" name="email" id="email" required>
				</div>
				...
				<div class="pure-control-group">
					<label class="theme" for="theme">Sujet</label>
					  ...
					  <input type="radio" name="theme" value="other"> Autre
				</div>

				<div class="pure-control-group">
				<label for="issue">Expliquez-nous votre problème</label>
